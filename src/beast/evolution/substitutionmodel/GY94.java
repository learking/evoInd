...
public class GY94 extends GeneralSubstitutionModel {
    ...
    protected void setupRateMatrix() {
    	...
    	rateMatrix[0][48] = fFreqs[48] * omega ; 	//AAA->TAA: IS NonSynonymous;
    	...
    	rateMatrix[1][49] = fFreqs[49] * omega ; 	//AAC->TAC: IS NonSynonymous;
    	...
    	rateMatrix[2][50] = fFreqs[50] * omega ; 	//AAG->TAG: IS NonSynonymous;
    	...
    	rateMatrix[3][51] = fFreqs[51] * omega ; 	//AAT->TAT: IS NonSynonymous;
    	...
    	rateMatrix[4][52] = fFreqs[52] * omega ; 	//ACA->TCA: IS NonSynonymous;
    	...
    	rateMatrix[5][53] = fFreqs[53] * omega ; 	//ACC->TCC: IS NonSynonymous;
    	...
    	rateMatrix[6][54] = fFreqs[54] * omega ; 	//ACG->TCG: IS NonSynonymous;
    	...
    	rateMatrix[7][55] = fFreqs[55] * omega ; 	//ACT->TCT: IS NonSynonymous;
    	...
    	rateMatrix[8][56] = fFreqs[56] * omega ; 	//AGA->TGA: IS NonSynonymous;
    	...
    	rateMatrix[9][57] = fFreqs[57] * omega ; 	//AGC->TGC: IS NonSynonymous;
    	...
    	rateMatrix[10][58] = fFreqs[58] * omega ; 	//AGG->TGG: IS NonSynonymous;
    	...
    	rateMatrix[11][59] = fFreqs[59] * omega ; 	//AGT->TGT: IS NonSynonymous;
    	...
    	rateMatrix[12][60] = fFreqs[60] * omega ; 	//ATA->TTA: IS NonSynonymous;
    	...
    	rateMatrix[13][61] = fFreqs[61] * omega ; 	//ATC->TTC: IS NonSynonymous;
    	...
    	rateMatrix[14][62] = fFreqs[62] * omega ; 	//ATG->TTG: IS NonSynonymous;
    	...
    	rateMatrix[15][63] = fFreqs[63] * omega ; 	//ATT->TTT: IS NonSynonymous;
    	...
    	rateMatrix[16][48] = fFreqs[48] * k * omega ; 	//CAA->TAA: IS Transition;IS NonSynonymous;
    	...
    	rateMatrix[17][49] = fFreqs[49] * k * omega ; 	//CAC->TAC: IS Transition;IS NonSynonymous;
    	...
    	rateMatrix[18][50] = fFreqs[50] * k * omega ; 	//CAG->TAG: IS Transition;IS NonSynonymous;
    	...
    	rateMatrix[19][51] = fFreqs[51] * k * omega ; 	//CAT->TAT: IS Transition;IS NonSynonymous;
    	...
    	rateMatrix[20][52] = fFreqs[52] * k * omega ; 	//CCA->TCA: IS Transition;IS NonSynonymous;
    	...
    	rateMatrix[21][53] = fFreqs[53] * k * omega ; 	//CCC->TCC: IS Transition;IS NonSynonymous;
    	...
    	rateMatrix[22][54] = fFreqs[54] * k * omega ; 	//CCG->TCG: IS Transition;IS NonSynonymous;
    	...
    	rateMatrix[23][55] = fFreqs[55] * k * omega ; 	//CCT->TCT: IS Transition;IS NonSynonymous;
    	...
    	rateMatrix[24][56] = fFreqs[56] * k * omega ; 	//CGA->TGA: IS Transition;IS NonSynonymous;
    	...
    	rateMatrix[25][57] = fFreqs[57] * k * omega ; 	//CGC->TGC: IS Transition;IS NonSynonymous;
    	...
    	rateMatrix[26][58] = fFreqs[58] * k * omega ; 	//CGG->TGG: IS Transition;IS NonSynonymous;
    	...
    	rateMatrix[27][59] = fFreqs[59] * k * omega ; 	//CGT->TGT: IS Transition;IS NonSynonymous;
    	...
    	rateMatrix[28][60] = fFreqs[60] * k ; 	//CTA->TTA: IS Transition;
    	...
    	rateMatrix[29][61] = fFreqs[61] * k * omega ; 	//CTC->TTC: IS Transition;IS NonSynonymous;
    	...
    	rateMatrix[30][62] = fFreqs[62] * k ; 	//CTG->TTG: IS Transition;
    	...
    	rateMatrix[31][63] = fFreqs[63] * k * omega ; 	//CTT->TTT: IS Transition;IS NonSynonymous;
    	...
    	rateMatrix[32][48] = fFreqs[48] * omega ; 	//GAA->TAA: IS NonSynonymous;
    	...
    	rateMatrix[33][49] = fFreqs[49] * omega ; 	//GAC->TAC: IS NonSynonymous;
    	...
    	rateMatrix[34][50] = fFreqs[50] * omega ; 	//GAG->TAG: IS NonSynonymous;
    	...
    	rateMatrix[35][51] = fFreqs[51] * omega ; 	//GAT->TAT: IS NonSynonymous;
    	...
    	rateMatrix[36][52] = fFreqs[52] * omega ; 	//GCA->TCA: IS NonSynonymous;
    	...
    	rateMatrix[37][53] = fFreqs[53] * omega ; 	//GCC->TCC: IS NonSynonymous;
    	...
    	rateMatrix[38][54] = fFreqs[54] * omega ; 	//GCG->TCG: IS NonSynonymous;
    	...
    	rateMatrix[39][55] = fFreqs[55] * omega ; 	//GCT->TCT: IS NonSynonymous;
    	...
    	rateMatrix[40][56] = fFreqs[56] * omega ; 	//GGA->TGA: IS NonSynonymous;
    	...
    	rateMatrix[41][57] = fFreqs[57] * omega ; 	//GGC->TGC: IS NonSynonymous;
    	...
    	rateMatrix[42][58] = fFreqs[58] * omega ; 	//GGG->TGG: IS NonSynonymous;
    	...
    	rateMatrix[43][59] = fFreqs[59] * omega ; 	//GGT->TGT: IS NonSynonymous;
    	...
    	rateMatrix[44][60] = fFreqs[60] * omega ; 	//GTA->TTA: IS NonSynonymous;
    	...
    	rateMatrix[45][61] = fFreqs[61] * omega ; 	//GTC->TTC: IS NonSynonymous;
    	...
    	rateMatrix[46][62] = fFreqs[62] * omega ; 	//GTG->TTG: IS NonSynonymous;
    	...
    	rateMatrix[47][63] = fFreqs[63] * omega ; 	//GTT->TTT: IS NonSynonymous;
    	rateMatrix[48][0] = fFreqs[0] * omega ; 	//TAA->AAA: IS NonSynonymous;
    	rateMatrix[48][16] = fFreqs[16] * k * omega ; 	//TAA->CAA: IS Transition;IS NonSynonymous;
    	rateMatrix[48][32] = fFreqs[32] * omega ; 	//TAA->GAA: IS NonSynonymous;
    	rateMatrix[48][49] = fFreqs[49] * omega ; 	//TAA->TAC: IS NonSynonymous;
    	rateMatrix[48][50] = fFreqs[50] * k ; 	//TAA->TAG: IS Transition;
    	rateMatrix[48][51] = fFreqs[51] * omega ; 	//TAA->TAT: IS NonSynonymous;
    	rateMatrix[48][52] = fFreqs[52] * omega ; 	//TAA->TCA: IS NonSynonymous;
    	rateMatrix[48][56] = fFreqs[56] * k ; 	//TAA->TGA: IS Transition;
    	rateMatrix[48][60] = fFreqs[60] * omega ; 	//TAA->TTA: IS NonSynonymous;
    	rateMatrix[49][1] = fFreqs[1] * omega ; 	//TAC->AAC: IS NonSynonymous;
    	rateMatrix[49][17] = fFreqs[17] * k * omega ; 	//TAC->CAC: IS Transition;IS NonSynonymous;
    	rateMatrix[49][33] = fFreqs[33] * omega ; 	//TAC->GAC: IS NonSynonymous;
    	rateMatrix[49][48] = fFreqs[48] * omega ; 	//TAC->TAA: IS NonSynonymous;
    	rateMatrix[49][50] = fFreqs[50] * omega ; 	//TAC->TAG: IS NonSynonymous;
    	rateMatrix[49][51] = fFreqs[51] * k ; 	//TAC->TAT: IS Transition;
    	rateMatrix[49][53] = fFreqs[53] * omega ; 	//TAC->TCC: IS NonSynonymous;
    	rateMatrix[49][57] = fFreqs[57] * k * omega ; 	//TAC->TGC: IS Transition;IS NonSynonymous;
    	rateMatrix[49][61] = fFreqs[61] * omega ; 	//TAC->TTC: IS NonSynonymous;
    	rateMatrix[50][2] = fFreqs[2] * omega ; 	//TAG->AAG: IS NonSynonymous;
    	rateMatrix[50][18] = fFreqs[18] * k * omega ; 	//TAG->CAG: IS Transition;IS NonSynonymous;
    	rateMatrix[50][34] = fFreqs[34] * omega ; 	//TAG->GAG: IS NonSynonymous;
    	rateMatrix[50][48] = fFreqs[48] * k ; 	//TAG->TAA: IS Transition;
    	rateMatrix[50][49] = fFreqs[49] * omega ; 	//TAG->TAC: IS NonSynonymous;
    	rateMatrix[50][51] = fFreqs[51] * omega ; 	//TAG->TAT: IS NonSynonymous;
    	rateMatrix[50][54] = fFreqs[54] * omega ; 	//TAG->TCG: IS NonSynonymous;
    	rateMatrix[50][58] = fFreqs[58] * k * omega ; 	//TAG->TGG: IS Transition;IS NonSynonymous;
    	rateMatrix[50][62] = fFreqs[62] * omega ; 	//TAG->TTG: IS NonSynonymous;
    	rateMatrix[51][3] = fFreqs[3] * omega ; 	//TAT->AAT: IS NonSynonymous;
    	rateMatrix[51][19] = fFreqs[19] * k * omega ; 	//TAT->CAT: IS Transition;IS NonSynonymous;
    	rateMatrix[51][35] = fFreqs[35] * omega ; 	//TAT->GAT: IS NonSynonymous;
    	rateMatrix[51][48] = fFreqs[48] * omega ; 	//TAT->TAA: IS NonSynonymous;
    	rateMatrix[51][49] = fFreqs[49] * k ; 	//TAT->TAC: IS Transition;
    	rateMatrix[51][50] = fFreqs[50] * omega ; 	//TAT->TAG: IS NonSynonymous;
    	rateMatrix[51][55] = fFreqs[55] * omega ; 	//TAT->TCT: IS NonSynonymous;
    	rateMatrix[51][59] = fFreqs[59] * k * omega ; 	//TAT->TGT: IS Transition;IS NonSynonymous;
    	rateMatrix[51][63] = fFreqs[63] * omega ; 	//TAT->TTT: IS NonSynonymous;
    	rateMatrix[52][4] = fFreqs[4] * omega ; 	//TCA->ACA: IS NonSynonymous;
    	rateMatrix[52][20] = fFreqs[20] * k * omega ; 	//TCA->CCA: IS Transition;IS NonSynonymous;
    	rateMatrix[52][36] = fFreqs[36] * omega ; 	//TCA->GCA: IS NonSynonymous;
    	rateMatrix[52][48] = fFreqs[48] * omega ; 	//TCA->TAA: IS NonSynonymous;
    	rateMatrix[52][53] = fFreqs[53] ; 	//TCA->TCC: 
    	rateMatrix[52][54] = fFreqs[54] * k ; 	//TCA->TCG: IS Transition;
    	rateMatrix[52][55] = fFreqs[55] ; 	//TCA->TCT: 
    	rateMatrix[52][56] = fFreqs[56] * omega ; 	//TCA->TGA: IS NonSynonymous;
    	rateMatrix[52][60] = fFreqs[60] * k * omega ; 	//TCA->TTA: IS Transition;IS NonSynonymous;
    	rateMatrix[53][5] = fFreqs[5] * omega ; 	//TCC->ACC: IS NonSynonymous;
    	rateMatrix[53][21] = fFreqs[21] * k * omega ; 	//TCC->CCC: IS Transition;IS NonSynonymous;
    	rateMatrix[53][37] = fFreqs[37] * omega ; 	//TCC->GCC: IS NonSynonymous;
    	rateMatrix[53][49] = fFreqs[49] * omega ; 	//TCC->TAC: IS NonSynonymous;
    	rateMatrix[53][52] = fFreqs[52] ; 	//TCC->TCA: 
    	rateMatrix[53][54] = fFreqs[54] ; 	//TCC->TCG: 
    	rateMatrix[53][55] = fFreqs[55] * k ; 	//TCC->TCT: IS Transition;
    	rateMatrix[53][57] = fFreqs[57] * omega ; 	//TCC->TGC: IS NonSynonymous;
    	rateMatrix[53][61] = fFreqs[61] * k * omega ; 	//TCC->TTC: IS Transition;IS NonSynonymous;
    	rateMatrix[54][6] = fFreqs[6] * omega ; 	//TCG->ACG: IS NonSynonymous;
    	rateMatrix[54][22] = fFreqs[22] * k * omega ; 	//TCG->CCG: IS Transition;IS NonSynonymous;
    	rateMatrix[54][38] = fFreqs[38] * omega ; 	//TCG->GCG: IS NonSynonymous;
    	rateMatrix[54][50] = fFreqs[50] * omega ; 	//TCG->TAG: IS NonSynonymous;
    	rateMatrix[54][52] = fFreqs[52] * k ; 	//TCG->TCA: IS Transition;
    	rateMatrix[54][53] = fFreqs[53] ; 	//TCG->TCC: 
    	rateMatrix[54][55] = fFreqs[55] ; 	//TCG->TCT: 
    	rateMatrix[54][58] = fFreqs[58] * omega ; 	//TCG->TGG: IS NonSynonymous;
    	rateMatrix[54][62] = fFreqs[62] * k * omega ; 	//TCG->TTG: IS Transition;IS NonSynonymous;
    	rateMatrix[55][7] = fFreqs[7] * omega ; 	//TCT->ACT: IS NonSynonymous;
    	rateMatrix[55][23] = fFreqs[23] * k * omega ; 	//TCT->CCT: IS Transition;IS NonSynonymous;
    	rateMatrix[55][39] = fFreqs[39] * omega ; 	//TCT->GCT: IS NonSynonymous;
    	rateMatrix[55][51] = fFreqs[51] * omega ; 	//TCT->TAT: IS NonSynonymous;
    	rateMatrix[55][52] = fFreqs[52] ; 	//TCT->TCA: 
    	rateMatrix[55][53] = fFreqs[53] * k ; 	//TCT->TCC: IS Transition;
    	rateMatrix[55][54] = fFreqs[54] ; 	//TCT->TCG: 
    	rateMatrix[55][59] = fFreqs[59] * omega ; 	//TCT->TGT: IS NonSynonymous;
    	rateMatrix[55][63] = fFreqs[63] * k * omega ; 	//TCT->TTT: IS Transition;IS NonSynonymous;
    	rateMatrix[56][8] = fFreqs[8] * omega ; 	//TGA->AGA: IS NonSynonymous;
    	rateMatrix[56][24] = fFreqs[24] * k * omega ; 	//TGA->CGA: IS Transition;IS NonSynonymous;
    	rateMatrix[56][40] = fFreqs[40] * omega ; 	//TGA->GGA: IS NonSynonymous;
    	rateMatrix[56][48] = fFreqs[48] * k ; 	//TGA->TAA: IS Transition;
    	rateMatrix[56][52] = fFreqs[52] * omega ; 	//TGA->TCA: IS NonSynonymous;
    	rateMatrix[56][57] = fFreqs[57] * omega ; 	//TGA->TGC: IS NonSynonymous;
    	rateMatrix[56][58] = fFreqs[58] * k * omega ; 	//TGA->TGG: IS Transition;IS NonSynonymous;
    	rateMatrix[56][59] = fFreqs[59] * omega ; 	//TGA->TGT: IS NonSynonymous;
    	rateMatrix[56][60] = fFreqs[60] * omega ; 	//TGA->TTA: IS NonSynonymous;
    	rateMatrix[57][9] = fFreqs[9] * omega ; 	//TGC->AGC: IS NonSynonymous;
    	rateMatrix[57][25] = fFreqs[25] * k * omega ; 	//TGC->CGC: IS Transition;IS NonSynonymous;
    	rateMatrix[57][41] = fFreqs[41] * omega ; 	//TGC->GGC: IS NonSynonymous;
    	rateMatrix[57][49] = fFreqs[49] * k * omega ; 	//TGC->TAC: IS Transition;IS NonSynonymous;
    	rateMatrix[57][53] = fFreqs[53] * omega ; 	//TGC->TCC: IS NonSynonymous;
    	rateMatrix[57][56] = fFreqs[56] * omega ; 	//TGC->TGA: IS NonSynonymous;
    	rateMatrix[57][58] = fFreqs[58] * omega ; 	//TGC->TGG: IS NonSynonymous;
    	rateMatrix[57][59] = fFreqs[59] * k ; 	//TGC->TGT: IS Transition;
    	rateMatrix[57][61] = fFreqs[61] * omega ; 	//TGC->TTC: IS NonSynonymous;
    	rateMatrix[58][10] = fFreqs[10] * omega ; 	//TGG->AGG: IS NonSynonymous;
    	rateMatrix[58][26] = fFreqs[26] * k * omega ; 	//TGG->CGG: IS Transition;IS NonSynonymous;
    	rateMatrix[58][42] = fFreqs[42] * omega ; 	//TGG->GGG: IS NonSynonymous;
    	rateMatrix[58][50] = fFreqs[50] * k * omega ; 	//TGG->TAG: IS Transition;IS NonSynonymous;
    	rateMatrix[58][54] = fFreqs[54] * omega ; 	//TGG->TCG: IS NonSynonymous;
    	rateMatrix[58][56] = fFreqs[56] * k * omega ; 	//TGG->TGA: IS Transition;IS NonSynonymous;
    	rateMatrix[58][57] = fFreqs[57] * omega ; 	//TGG->TGC: IS NonSynonymous;
    	rateMatrix[58][59] = fFreqs[59] * omega ; 	//TGG->TGT: IS NonSynonymous;
    	rateMatrix[58][62] = fFreqs[62] * omega ; 	//TGG->TTG: IS NonSynonymous;
    	rateMatrix[59][11] = fFreqs[11] * omega ; 	//TGT->AGT: IS NonSynonymous;
    	rateMatrix[59][27] = fFreqs[27] * k * omega ; 	//TGT->CGT: IS Transition;IS NonSynonymous;
    	rateMatrix[59][43] = fFreqs[43] * omega ; 	//TGT->GGT: IS NonSynonymous;
    	rateMatrix[59][51] = fFreqs[51] * k * omega ; 	//TGT->TAT: IS Transition;IS NonSynonymous;
    	rateMatrix[59][55] = fFreqs[55] * omega ; 	//TGT->TCT: IS NonSynonymous;
    	rateMatrix[59][56] = fFreqs[56] * omega ; 	//TGT->TGA: IS NonSynonymous;
    	rateMatrix[59][57] = fFreqs[57] * k ; 	//TGT->TGC: IS Transition;
    	rateMatrix[59][58] = fFreqs[58] * omega ; 	//TGT->TGG: IS NonSynonymous;
    	rateMatrix[59][63] = fFreqs[63] * omega ; 	//TGT->TTT: IS NonSynonymous;
    	rateMatrix[60][12] = fFreqs[12] * omega ; 	//TTA->ATA: IS NonSynonymous;
    	rateMatrix[60][28] = fFreqs[28] * k ; 	//TTA->CTA: IS Transition;
    	rateMatrix[60][44] = fFreqs[44] * omega ; 	//TTA->GTA: IS NonSynonymous;
    	rateMatrix[60][48] = fFreqs[48] * omega ; 	//TTA->TAA: IS NonSynonymous;
    	rateMatrix[60][52] = fFreqs[52] * k * omega ; 	//TTA->TCA: IS Transition;IS NonSynonymous;
    	rateMatrix[60][56] = fFreqs[56] * omega ; 	//TTA->TGA: IS NonSynonymous;
    	rateMatrix[60][61] = fFreqs[61] * omega ; 	//TTA->TTC: IS NonSynonymous;
    	rateMatrix[60][62] = fFreqs[62] * k ; 	//TTA->TTG: IS Transition;
    	rateMatrix[60][63] = fFreqs[63] * omega ; 	//TTA->TTT: IS NonSynonymous;
    	rateMatrix[61][13] = fFreqs[13] * omega ; 	//TTC->ATC: IS NonSynonymous;
    	rateMatrix[61][29] = fFreqs[29] * k * omega ; 	//TTC->CTC: IS Transition;IS NonSynonymous;
    	rateMatrix[61][45] = fFreqs[45] * omega ; 	//TTC->GTC: IS NonSynonymous;
    	rateMatrix[61][49] = fFreqs[49] * omega ; 	//TTC->TAC: IS NonSynonymous;
    	rateMatrix[61][53] = fFreqs[53] * k * omega ; 	//TTC->TCC: IS Transition;IS NonSynonymous;
    	rateMatrix[61][57] = fFreqs[57] * omega ; 	//TTC->TGC: IS NonSynonymous;
    	rateMatrix[61][60] = fFreqs[60] * omega ; 	//TTC->TTA: IS NonSynonymous;
    	rateMatrix[61][62] = fFreqs[62] * omega ; 	//TTC->TTG: IS NonSynonymous;
    	rateMatrix[61][63] = fFreqs[63] * k ; 	//TTC->TTT: IS Transition;
    	rateMatrix[62][14] = fFreqs[14] * omega ; 	//TTG->ATG: IS NonSynonymous;
    	rateMatrix[62][30] = fFreqs[30] * k ; 	//TTG->CTG: IS Transition;
    	rateMatrix[62][46] = fFreqs[46] * omega ; 	//TTG->GTG: IS NonSynonymous;
    	rateMatrix[62][50] = fFreqs[50] * omega ; 	//TTG->TAG: IS NonSynonymous;
    	rateMatrix[62][54] = fFreqs[54] * k * omega ; 	//TTG->TCG: IS Transition;IS NonSynonymous;
    	rateMatrix[62][58] = fFreqs[58] * omega ; 	//TTG->TGG: IS NonSynonymous;
    	rateMatrix[62][60] = fFreqs[60] * k ; 	//TTG->TTA: IS Transition;
    	rateMatrix[62][61] = fFreqs[61] * omega ; 	//TTG->TTC: IS NonSynonymous;
    	rateMatrix[62][63] = fFreqs[63] * omega ; 	//TTG->TTT: IS NonSynonymous;
    	rateMatrix[63][15] = fFreqs[15] * omega ; 	//TTT->ATT: IS NonSynonymous;
    	rateMatrix[63][31] = fFreqs[31] * k * omega ; 	//TTT->CTT: IS Transition;IS NonSynonymous;
    	rateMatrix[63][47] = fFreqs[47] * omega ; 	//TTT->GTT: IS NonSynonymous;
    	rateMatrix[63][51] = fFreqs[51] * omega ; 	//TTT->TAT: IS NonSynonymous;
    	rateMatrix[63][55] = fFreqs[55] * k * omega ; 	//TTT->TCT: IS Transition;IS NonSynonymous;
    	rateMatrix[63][59] = fFreqs[59] * omega ; 	//TTT->TGT: IS NonSynonymous;
    	rateMatrix[63][60] = fFreqs[60] * omega ; 	//TTT->TTA: IS NonSynonymous;
    	rateMatrix[63][61] = fFreqs[61] * k ; 	//TTT->TTC: IS Transition;
    	rateMatrix[63][62] = fFreqs[62] * omega ; 	//TTT->TTG: IS NonSynonymous;
