...
public class GY94Codon61PAML2SeqTreeLikelihoodTest extends TestCase {
    ...
    static public Tree getTree(Alignment data) throws Exception {
        ...
        tree.initByName("taxa", data,
                "newick", "(Human:1.0, Chimpanzee:1.0);",
        ...
        /*
        tree.initByName("taxa", data,
                "newick", "(Human:0.000001, Chimpanzee:0.000001);",
                "IsLabelledNewick", true);
                */
        
      //test for short tree
        tree.initByName("taxa", data,
                "newick", "(Human:100000, Chimpanzee:100000);",
                "IsLabelledNewick", true);
    ...
    static public Alignment getCodonAlignment() throws Exception {
        Sequence human = new Sequence("Human", "AAGCTTCAC");
        Sequence chimp = new Sequence("Chimpanzee", "AAGCTTCAC");
    ...
    @Test
    public void testGY94Codon61PAML2SeqTreeLikelihood() throws Exception {
