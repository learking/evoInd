...
public class GY94Codon61PAML3SeqOneDiffTreeLikelihoodTest extends TestCase {
    ...
    static public Tree getTree(Alignment data) throws Exception {
        ...
        tree.initByName("taxa", data,
                "newick", "((Human:0.004, Chimpanzee:0.004):0.002,Gorilla:0.006);",
    ...
    static public Alignment getCodonAlignment() throws Exception {
        ...
        Sequence gorilla = new Sequence("Gorilla", "AAGCTTCAC");
