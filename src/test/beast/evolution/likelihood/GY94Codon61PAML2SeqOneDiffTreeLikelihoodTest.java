...
public class GY94Codon61PAML2SeqOneDiffTreeLikelihoodTest extends TestCase {
    ...
    static public Tree getTree(Alignment data) throws Exception {
        ...
        tree.initByName("taxa", data,
                "newick", "(Human:0.004, Chimpanzee:0.004);",
                "IsLabelledNewick", true);
    ...
    static public Alignment getCodonAlignment() throws Exception {
        Sequence human = new Sequence("Human", "AATCTTCAC");
    ...
    @Test
    public void testGY94Codon61PAMLoneDiffTreeLikelihood() throws Exception {
